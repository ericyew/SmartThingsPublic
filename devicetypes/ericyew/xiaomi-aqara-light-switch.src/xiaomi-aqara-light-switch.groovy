...
metadata {
	definition (name: "Xiaomi Aqara Smart Light Switch", namespace: "ericyew", author: "Eric Yew") {	
    	capability "Battery"
		capability "Button"
		capability "Actuator"
		capability "Switch"
...
//		}
		...
		main (["switch"])
			details(["switch", "battery" , "lastcheckin", "batteryVolts", "batteryRuntime"]) //, "configure" , "refresh" , "lastcheckin"
	}
}
